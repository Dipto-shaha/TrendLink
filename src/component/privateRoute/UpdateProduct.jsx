...
const UpdateProduct = () => {
    ...
    const handleUpdateProduct = e =>{
        ...
        console.log(product);
        fetch(`http://localhost:5000/updateProduct/${info._id}`, {
          method: "PUT",
          headers: {
       ...
       <div className="bg-[#5154745F] lg:mx-20 mx-10 py-10 my-10 px-20">
        ...
        <form onSubmit={handleUpdateProduct}>
          <div className="grid grid-cols-1 md:grid-cols-2 custom ">
            ...
            <div>
              <label>Price</label>
              <input name='price' type="text"   defaultValue={info.price}  required/>
            </div>
          ...
          <div className="w-full custom">
            ...
            <textarea
              defaultValue={info.description}  name='description'
